...
useEffect(() => {
  ...
  {/* {bottom area for input field and send button} */}

  <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
    <div className='flex-1 flex items-center gap-3  bg-white/10 px-3 rounded-full'>
    ...
    <div className='h-full flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
      <img src={assets.logo_icon} alt="chat" className='max-w-16'/>
