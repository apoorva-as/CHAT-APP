...
const LoginPage = () => {
  ...
  <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
    ...
    {currState === "Signup" && !isDataSubmitted && (
      ...
      {!isDataSubmitted && ( 
        <>
        <input onChange={(e)=>setEmail(e.target.value)} value={email} type='email' placeholder="Email Address" className='p-2 border border-gray-500 rounded-md focus:outline-none focus:right-2 focus:right-indigo-500 '/>
        <input onChange={(e)=>setPassword(e.target.value)} value={password} type='password' placeholder="Password" className='p-2 border border-gray-500 rounded-md focus:outline-none focus:right-2 focus:right-indigo-500 '/>
